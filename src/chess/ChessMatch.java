...
public class ChessMatch {
    ...
    public ChessPiece[][] getPieces(){
        ...
        for (int i=0; i< board.getRows(); i++){
            for (int j=0; j<board.getRows(); j++){
                mat[i][j] = (ChessPiece) board.piece(i,j); //downcasting força a interpretação para PEÇA DE XADREZ
            }
        }
        return mat;
    }
    ...
    private boolean testCheckMate(Color color){
            ...
            for (int i = 0; i < board.getRows(); i++){
                for (int k = 0; k < board.getColumns(); k++){
                    if (mat[i][k]){
                        ...
                        if (!testCheck){
                            return false; // Se após o movimento a situação não é mais xeque, não é xeque-mate
                        }
                    }
                }
            }
        ...
        return true; // Se nenhum movimento resolve o xeque, então é xeque-mate
    }
