...
public class UI {
    //boilerplate -> https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
    ...
    //boilerplate -> https://stackoverflow.com/questions/2979383/how-to-clear-the-console-using-java
    ...
    public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured){
        ...
        if (!chessMatch.getCheck()) {
            ...
            if (chessMatch.getCheck()) {
                System.out.println("VOCÊ TA EM CHEQUE, PARCEIRO!");
            }
        }
        else {
            System.out.println("MEU BOM, AQUI É XEQUE-MATE!");
